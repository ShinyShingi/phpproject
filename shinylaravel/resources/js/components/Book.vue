...
<template>
    <div class="book">
        ...
        <span>
            Status:
            <select class="form-select" v-model="props.book.status" @change="updateStatus($event.target.value)">
                <option value="unread">Unread</option>
                <option value="reading">Reading</option>
                <option value="read">Read</option>
            </select>
        </span>
        <button @click="removeBook" class="btn btn-danger delete-book-btn">Remove</button>
